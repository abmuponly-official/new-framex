...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: t('headline'),
    description: t('sub'),
    alternates: { languages: { vi: '/vi/nha-thau', en: '/en/nha-thau' } },
  };
}
...
export default async function ContractorPage({ params }: Props) {
  ...
  return (
    <>
      ...
      {/* ── 2. PAIN ── */}
      <section className="section-padding bg-brand-white" aria-labelledby="contractor-pain-heading">
      ...
      <section className="section-padding bg-brand-white" aria-labelledby="contractor-flow-heading">
        <div className="container-base">
          <h2
      ...
      {/* ── 6. TRUST SIGNALS ── */}
      <section className="section-padding bg-brand-white" aria-labelledby="contractor-trust-heading">
        <div className="container-base">
          <h2
